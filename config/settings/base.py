...
MIGRATION_MODULES = {"sites": "stayease.contrib.sites.migrations"}
...
ADMINS = ['"Mobin Varghese" <mobinvarghese14@gmail.com>']
...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_SIGNUP_FIELDS = ["email*", "first_name*", "last_name*", "phone_number*", "role*", "password1*", "password2*"]
# https://docs.allauth.org/en/latest/account/configuration.html
...
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "stayease.users.forms.UserSocialSignupForm"}
